    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent>
        ...
        <div className="mt-4 pt-4 border-t">
          <p className="text-xs text-muted-foreground">
            Your server processes these credentials to call Google Play. The session is encrypted in an HTTP-only cookie. No credentials are sent to pricing-kit.com.
          </p>
        </div>
      </CardContent>
    </Card>
